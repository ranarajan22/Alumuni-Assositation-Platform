...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        const url = userType === 'alumni'
            ? 'http://localhost:8083/api/alumni/login' // Alumni login endpoint
            : 'http://localhost:8083/auth/login'; // Student login endpoint
        ...
        try {
            ...
            if (success) {
                ...
                setTimeout(() => {
                    navigate('/dashboard');
                }, 1000); // Reduced timeout to improve user experience
            } else {
